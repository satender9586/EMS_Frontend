                ...
                <div className="flex gap-2 ">
                    ...
                    <div className="w-[160px] ">
                        ...
                        <h1 className=" text-[#777777] text-[13px]  font-[400] leading-[16px] break-words">
                            Infomation Technologies Department
                        </h1>
                    ...
                    <div className=" flex-1 flex items-end flex-col">
                        ...
                        <div className="flex items-center  mt-2 gap-2">
                            <HoverCard>
                                <HoverCardTrigger className="bg-[#FFF2CA] p-2 rounded-full"><PiWarning /></HoverCardTrigger>
                                <HoverCardContent>
                                    The React Framework – created and maintained by @vercel.
                                </HoverCardContent>
                            </HoverCard>
                            <h1 className="bg-[#D9EDDA] rounded-full text-green-600 p-1 px-3 rounded-fullfont-[500] text-[12px]">Active</h1>
                        </div>
