...
const Card = () => {
  return (
    <div className="bg-white border border-gray-200 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-4 min-h-[160px] flex flex-col justify-between">
